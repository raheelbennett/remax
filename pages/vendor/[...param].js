...
const Vendor = ({ categories, vendor, listings }) => {
  ...
  return (
    <section>
      ...
      <h2 className="text-xl font-bold mb-4 text-center dark:text-gray-300 ">{vendor[0].name}</h2>
      ...
      <div className="card-list grid grid-cols-1 gap-10 m-10">
        ...
        {listings.length > 0 && (
          <div
            className="p-6 rounded-lg shadow-md bg-amber-100 hover:bg-amber-200  dark:shadow-green-500/40 dark:bg-green-500 dark:hover:bg-green-400"
            key={main.card_id}
          >
            <Link href={`/cards/${main.card_id}`}>
              <div className=" grid grid-cols-2">
                ...
                <div className="col-start-2 col-end-3 ">
                  <h3 className="text-xl font-bold text-gray-700 dark:text-gray-900">{main.name}</h3>
                  ...
                  <div className="text-sm text-gray-700 dark:text-gray-300">Annual Fee: ${main.annual_fee}</div>
                  <div className="text-sm text-gray-700 dark:text-gray-300">Interest Rate: {main.interest_rate}%</div>
                </div>
              </div>
            </Link>
          </div>
